...
var index_cjs$2 = require('../../../tools/dist/index.cjs');
...
function isZodSchema(obj) {
    return obj !== null && typeof obj === "object" && "parse" in obj && typeof obj.parse === "function" && "safeParse" in obj && typeof obj.safeParse === "function" && "_def" in obj;
}
...
class BaseLLM {
    ...
    async exec(params) {
        ...
        if (typeof responseFormat != "undefined" && isZodSchema(responseFormat)) {
            const structuredTool = index_cjs$2.tool({
                name: "format_output",
